...
So if we could be alerted when a new file is created in that directory, we'll be good. And that's exactly what [inotify](https://man7.org/linux/man-pages/man7/inotify.7.html) does.
