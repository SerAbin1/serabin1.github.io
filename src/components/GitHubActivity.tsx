      ...
      <div className="space-y-8 w-full py-8 md:py-12">
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center px-4">
          <div className="space-y-2">
            <h2 className="text-2xl font-bold tracking-tighter text-gray-100 sm:text-3xl md:text-5xl">
              My GitHub Activity
            </h2>
            <p className="text-gray-400 text-base md:text-xl/relaxed">
        ...
        <div className="hidden md:flex justify-center">
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 max-w-4xl">
            <GitHubCalendar
              username={username}
              blockSize={14}
              blockMargin={5}
